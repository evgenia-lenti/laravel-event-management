...
return [
    ...
    'description' => 'Event Management API for managing events, registrations, and users.',
    ...
    'auth' => [
        ...
        'extra_info' => 'You can obtain a token by making a POST request to the `/api/v1/login` endpoint with your email and password.',
    ],
