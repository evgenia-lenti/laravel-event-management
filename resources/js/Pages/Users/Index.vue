...
import {ref} from "vue";
import UserRow from "@/Pages/Users/Partials/UserRow.vue";
                        ...
                        <div class="px-4 sm:px-6 lg:px-8">
                            <div class="sm:flex sm:items-center">
                                <div class="sm:flex-auto">
                                    <h1 class="text-base font-semibold text-gray-800">Users</h1>
                                    <p class="mt-2 text-sm text-gray-700">A list of all users including their
                                        event registrations count.</p>
                                </div>
                                <Link
                                    v-if="can.create"
                                    ...
                                    <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                                        <table class="relative min-w-full divide-y divide-white/15">
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col"
                                                    class="px-3 py-3.5 text-left text-sm font-semibold text-gray-800 text-center">
