...
import { Bars3Icon, MinusIcon, PlusIcon, XMarkIcon } from '@heroicons/vue/24/outline'
import {
    ArrowPathIcon,
    CheckIcon,
    CloudArrowUpIcon,
        ...
        <header class="absolute inset-x-0 top-0 z-50">
            <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                    <a v-if="canLogin" :href="route('login')" class="text-sm/6 font-semibold text-white">Log in <span aria-hidden="true">&rarr;</span></a>
                    <button v-else
                        @click="logout"
                        class="text-sm/6 font-semibold text-white">Log out <span aria-hidden="true">&rarr;</span>
                    </button>
                </div>
            </nav>
                    ...
                    <div class="mt-6 flow-root">
                        <div class="-my-6 divide-y divide-gray-500/25">
                            <div v-if="canLogin" class="py-6">
                                ...
                                <button
                                    @click="logout"
                                    class="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-white hover:bg-gray-800">Log out
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mx-auto flex max-w-7xl flex-col items-center gap-x-8 gap-y-10 px-6 sm:gap-y-8 lg:px-8 xl:flex-row xl:items-stretch">
                    ...
                    <div class="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
                        <figure class="relative isolate pt-6 sm:pt-12">
                            <svg viewBox="0 0 162 128" aria-hidden="true" class="absolute top-0 left-0 -z-10 h-32 stroke-white/20">
